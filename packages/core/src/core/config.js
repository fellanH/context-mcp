  ...
  if (existsSync(configPath)) {
    try {
      ...
      if (fc.recall && typeof fc.recall === "object") {
        ...
        if (r.minRelevanceScore != null) config.recall.minRelevanceScore = Number(r.minRelevanceScore);
        if (Array.isArray(r.excludeKinds)) config.recall.excludeKinds = r.excludeKinds;
        if (Array.isArray(r.excludeCategories)) config.recall.excludeCategories = r.excludeCategories;
        if (r.bodyTruncateChars != null) config.recall.bodyTruncateChars = Number(r.bodyTruncateChars);
      }
      if (fc.consolidation && typeof fc.consolidation === "object") {
        ...
        if (c.autoConsolidate != null) config.consolidation.autoConsolidate = c.autoConsolidate === true;
      }
